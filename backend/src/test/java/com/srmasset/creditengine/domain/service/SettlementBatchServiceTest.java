...
class SettlementBatchServiceTest {
    ...
    @Mock private Settlement settlementOk1;

    @Mock private Settlement settlementOk3;
    ...
    void aFailingItemDoesNotStopOrRollBackTheOthers() {
        ...
        when(settlementService.settle(2L, "BRL", baseRate))
                .thenThrow(new ReceivableNotFoundException(2L));
        ...
        List<BatchSettlementItemResult> results =
                batchService.settleBatch(List.of(1L, 2L, 3L), "BRL", baseRate);
