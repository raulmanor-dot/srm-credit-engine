...
/**
 * Exercita o caminho paralelo direto: SettlementReportRepository (SQL nativo), sem passar por
 * SettlementController/Service — provando que o atalho funciona isoladamente contra dados reais
 * persistidos.
 */
class ReportControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    @Autowired private SettlementReportRepository settlementReportRepository;
    ...
    void findsStatementsFilteredByAssignor() {
        ...
        ReceivableType duplicata =
                receivableTypeRepository
                        ...
                        .orElseThrow();
        Assignor assignorA =
                assignorRepository.save(new Assignor("Cedente Report A", "55666777000188"));
        Assignor assignorB =
                assignorRepository.save(new Assignor("Cedente Report B", "66777888000199"));
