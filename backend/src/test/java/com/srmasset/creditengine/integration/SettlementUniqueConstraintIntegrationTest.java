...
/**
 * Defesa em profundidade (ver ADR 0004): mesmo que o optimistic lock de `receivables` não pegue uma
 * corrida, o banco rejeita fisicamente uma segunda linha em `settlements` para o mesmo
 * `receivable_id`.
 */
    ...
    void secondSettlementForSameReceivableViolatesUniqueConstraint() {
        ...
        ReceivableType duplicata =
                receivableTypeRepository
                        ...
                        .orElseThrow();
        Assignor assignor =
                assignorRepository.save(new Assignor("Empresa Unique", "33444555000133"));
