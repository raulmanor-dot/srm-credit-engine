...
/**
 * Convenção de contagem de prazo, explícita para eliminar a ambiguidade clássica de fórmulas com
 * taxa mensal: dias corridos entre a data de referência e o vencimento, divididos por 30 (mês
 * comercial de 30 dias). Não é dias úteis, não é a convenção bancária 30/360 completa — é a divisão
...
public final class TermCalculator {
    ...
    public static BigDecimal monthsBetween(
            LocalDate referenceDate, LocalDate dueDate, MathContext mc) {
