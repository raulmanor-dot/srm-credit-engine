...
/**
 * Métricas de negócio de liquidação, registradas em um único ponto
 * ({@link SettlementService#settle}) para não duplicar a instrumentação
 * entre o caminho do controller e o caminho de lote
 * ({@code SettlementBatchService}) — ver ADR 0007.
 */
@Component
public class SettlementMetricsRecorder {
	...
	public void recordSettlement(String paymentCurrencyCode, BigDecimal netValuePaymentCurrency) {
		...
		meterRegistry.summary("settlements.volume", "currency", paymentCurrencyCode)
