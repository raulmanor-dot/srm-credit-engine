...
/**
 * Knobs de caos do provedor mock: cada liquidação cross-currency que passa por aqui pode falhar
 * (simulando outage), atrasar (simulando rede lenta) ou variar levemente a cotação (simulando um
 * provedor real de câmbio).
 */
