...
/**
 * Projeção plana do extrato de liquidação — não é uma entidade JPA. Espelha exatamente as colunas
 * retornadas pela query SQL nativa de {@link SettlementReportRepository}.
 */
